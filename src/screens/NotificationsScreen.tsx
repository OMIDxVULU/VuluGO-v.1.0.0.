...
interface AnnouncementData {
  ...
  adminName: string; // Add admin name for clarity
  message: string;
  time: string;
  targetRoute: string;
...
const AnnouncementWidget = () => {
  ...
  const { updateAnnouncementCount, clearNotificationsByType } = useNotifications();
  ...
  const [announcements, setAnnouncements] = useState<AnnouncementData[]>([
    {
      id: 'a1',
      adminName: 'Admin Taylor',
      adminAvatar: generateAdminAvatar('Admin Taylor'),
    ...
    },
    {
      ...
      adminAvatar: generateAdminAvatar('System Admin'),
    ...
    {
      id: 'a3',
      adminName: 'Trading Team',
      adminAvatar: generateAdminAvatar('Trading Team'),
    ...
    {
      id: 'a4',
      adminName: 'Events Team',
      adminAvatar: generateAdminAvatar('Events Team'),
    ...
    },
    {
      ...
      adminAvatar: generateAdminAvatar('Community Manager'),
    ...
    },
    {
      id: 'a6',
      adminName: 'Dev Team',
      adminAvatar: generateAdminAvatar('Dev Team'),
    ...
    {
      id: 'a7',
      adminName: 'Onboarding Team',
      adminAvatar: generateAdminAvatar('Onboarding Team'),
  ...
  const toggleExpand = () => {
    ...
    if (expanding) {
        setUnreadCount(0);
        clearNotificationsByType('announcements');
    } else {
  ...
  // Replace the old useCallback and useEffect with a single useEffect with correct dependencies
  useEffect(() => {
    // Only update the count once when the component mounts or when unread count changes
    updateAnnouncementCount(unreadCount);
...
const FriendRequestWidget = () => {
  ...
  const { updateFriendRequestCount, clearNotificationsByType } = useNotifications();
  ...
  const initialRequests: FriendRequest[] = [
    { id: 'fr1', name: 'Jake Wilson', avatar: generateAvatar('Jake Wilson'), mutual: 3, userId: 'jakewilson', status: 'pending' },
    { id: 'fr2', name: 'Sophia Miller', avatar: generateAvatar('Sophia Miller'), mutual: 1, userId: 'sophiamiller', status: 'pending' },
    { id: 'fr3', name: 'Daniel Park', avatar: generateAvatar('Daniel Park'), mutual: 5, userId: 'danielpark', status: 'pending' },
    { id: 'fr4', name: 'Maya Johnson', avatar: generateAvatar('Maya Johnson'), mutual: 2, userId: 'mayajohnson', status: 'pending' },
    { id: 'fr5', name: 'Chris Davis', avatar: generateAvatar('Chris Davis'), mutual: 0, userId: 'chrisdavis', status: 'pending' },
    { id: 'fr6', name: 'Aria Rodriguez', avatar: generateAvatar('Aria Rodriguez'), mutual: 7, userId: 'ariarodriguez', status: 'pending' },
    { id: 'fr7', name: 'Tyler Smith', avatar: generateAvatar('Tyler Smith'), mutual: 4, userId: 'tylersmith', status: 'pending' },
    { id: 'fr8', name: 'Katie Lee', avatar: generateAvatar('Katie Lee'), mutual: 0, userId: 'katielee', status: 'pending' },
    { id: 'fr9', name: 'Marcus Santos', avatar: generateAvatar('Marcus Santos'), mutual: 6, userId: 'marcussantos', status: 'pending' },
    { id: 'fr10', name: 'Lucy Wang', avatar: generateAvatar('Lucy Wang'), mutual: 3, userId: 'lucywang', status: 'pending' },
    { id: 'fr11', name: 'Ryan Taylor', avatar: generateAvatar('Ryan Taylor'), mutual: 0, userId: 'ryantaylor', status: 'pending' },
    { id: 'fr12', name: 'Zoe Bennett', avatar: generateAvatar('Zoe Bennett'), mutual: 2, userId: 'zoebennett', status: 'pending' },
    { id: 'fr13', name: 'Alex Cooper', avatar: generateAvatar('Alex Cooper'), mutual: 1, userId: 'alexcooper', status: 'pending' },
    { id: 'fr14', name: 'Diana Chen', avatar: generateAvatar('Diana Chen'), mutual: 0, userId: 'dianachen', status: 'pending' },
    { id: 'fr15', name: 'Nathan Harris', avatar: generateAvatar('Nathan Harris'), mutual: 4, userId: 'nathanharris', status: 'pending' },
  ];
